...
/**
 * Práctica 11: Uso de diccionarios.
 */
public class Practica11 {
    ...
    public static void main(String[] args) {
        ...
        /* BFS */
        Diccionario<String, Color> colores = new Diccionario<String, Color>();
        for (String elemento :  grafica)
            colores.agrega(elemento, Color.ROJO);
        Cola<VerticeGrafica<String>> c = new Cola<VerticeGrafica<String>>();
        VerticeGrafica<String> vertice = grafica.vertice("a");
        colores.agrega(vertice.get(), Color.NEGRO);
        c.mete(vertice);
        cadena = "BFS 1: ";
        while (!c.esVacia()) {
            vertice = c.saca();
            ...
            for (VerticeGrafica<String> vecino : vertice.vecinos()) {
                if (colores.get(vecino.get()) == Color.ROJO) {
                    colores.agrega(vecino.get(), Color.NEGRO);
                    c.mete(vecino);
                }
            }
        }
